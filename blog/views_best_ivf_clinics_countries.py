...
def bestivfclinicsingermany(request):
    pkid = 6
    ...
    if count_snippets == 1:
        ...
        return render(request, 'blog/best-article/countries/germany/best-clinic-country-DE.html', context)
    elif count_snippets > 1:
        snippets = SnippetCountry.objects.filter(blog=pkid, status='is published', owner__coach_is_premium=True,
                                                 owner__coach_is_published=True)
...
def bestivfclinicsinlatvia(request):
    pkid = 7
    country = 'Latvia'
    ...
    if count_snippets == 1:
        ...
        return render(request, 'blog/best-article/countries/latvia/best-clinic-country-LV.html', context)
    elif count_snippets > 1:
        snippets = SnippetCountry.objects.filter(blog=pkid, status='is published', owner__coach_is_premium=True,
                                                 owner__coach_is_published=True)
