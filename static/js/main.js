...
$(document).ready(function (e) {
    $('#ChooseCurrencySP').change(function () {
        if ($(this).val() == 'USD') {
          ...
          $('#defaultGachibowli').hide();
          $('#defaultGurugram').hide();
          $('#defaultGwalior').hide();
          $('#defaultHaldwani').hide();
          ...
          $('#defaultMadhapur').hide();
          $('#defaultMeerut').hide();
          $('#defaultMumbai').hide();
          $('#defaultNagpur').hide();
          $('#defaultNewDelhi').hide();
          $('#defaultNoida').hide();
          $('#defaultPatna').hide();
          $('#defaultPune').hide();
          $('#defaultRaipur').hide();
          ...
          $('#defaultVadodara').hide();
          $('#defaultVijayawada').hide();
          $('#defaultVisakhapatnam').hide();
          $('#defaultWarangal').hide();
          ...
          $('#defaultGachibowli').show();
          $('#defaultGurugram').show();
          $('#defaultGwalior').show();
          $('#defaultHaldwani').show();
          ...
          $('#defaultMadhapur').show();
          $('#defaultMeerut').show();
          $('#defaultMumbai').show();
          $('#defaultNagpur').show();
          $('#defaultNewDelhi').show();
          $('#defaultNoida').show();
          $('#defaultPatna').show();
          $('#defaultPune').show();
          $('#defaultRaipur').show();
          ...
          $('#defaultVadodara').show();
          $('#defaultVijayawada').show();
          $('#defaultVisakhapatnam').show();
          $('#defaultWarangal').show();
        }
    });
});
