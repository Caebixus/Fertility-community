...
def locationsPTRegions(request):
    ...
    queryset_list_pt_natural_ivf_val = procedure_country_average_value('ivf_treatment_cost', country_name)
    queryset_list_pt_mild_ivf_val = procedure_country_average_value('mild_ivf_treatment_cost', country_name)
    queryset_list_pt_standard_ivf_val = procedure_country_average_value('ovarian_ivf_treatment_cost', country_name)
    queryset_list_pt_egg_ivf_val = procedure_country_average_value('egg_donor_recipients_cost', country_name)
    queryset_list_pt_known_egg_ivf_val = procedure_country_average_value('known_egg_donor_recipients_cost', country_name)
    queryset_list_pt_shared_egg_ivf_val = procedure_country_average_value('shared_egg_donor_recipients_cost', country_name)

    queryset_list_pt_embryo_ivf_val = procedure_country_average_value('embryo_donor_recipients_cost', country_name)
    queryset_list_pt_known_embryo_ivf_val = procedure_country_average_value('known_embryo_donor_recipients_cost', country_name)
    queryset_list_pt_sperm_ivf_val = procedure_country_average_value('sperm_donor_recipients_cost', country_name)
    queryset_list_pt_known_sperm_ivf_val = procedure_country_average_value('known_sperm_donor_recipients_cost', country_name)
    queryset_list_pt_icsi_val = procedure_country_average_value('icsi_treatment_cost', country_name)
    queryset_list_pt_iui_val = procedure_country_average_value('iui_treatment_cost', country_name)
    ...
    queryset_list_lisbon__ivf_val = procedure_region_average_value('ivf_treatment_cost', region_name)
    queryset_list_lisbon__egg_val = procedure_region_average_value('mild_ivf_treatment_cost', region_name)
    queryset_list_lisbon__embryo_val = procedure_region_average_value('ovarian_ivf_treatment_cost', region_name)
    queryset_list_lisbon__sperm_val = procedure_region_average_value('egg_donor_recipients_cost', region_name)
    queryset_list_lisbon__icsi_val = procedure_region_average_value('known_egg_donor_recipients_cost', region_name)
    queryset_list_lisbon__iui_val = procedure_region_average_value('shared_egg_donor_recipients_cost', region_name)
