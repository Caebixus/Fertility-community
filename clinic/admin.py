...
class PostAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ('The rest', {'fields': ('clinicGoogleReviewsUrl', 'description', 'treatmentLimitations', 'clinic_staff', 'type', 'clinicLiveChatChoice', 'clinicChatraCode', 'clinicLiveChatCode', 'clinicOlarkCode', 'clinicTidioCode')}),
    )
    actions = ['clinicLocationLink_update_g']

    def clinicLocationLink_update_g(modeladmin, request, queryset):
        queryset.update(clinicRegionLink='https://www.fertilitycommunity.com/fertility-clinics/usa/washington')
