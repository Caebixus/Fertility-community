...
def locationsSKRegions(request):
    ...
    queryset_list_sk_natural_ivf_val = procedure_country_average_value('ivf_treatment_cost', country_name)
    queryset_list_sk_mild_ivf_val = procedure_country_average_value('mild_ivf_treatment_cost', country_name)
    queryset_list_sk_standard_ivf_val = procedure_country_average_value('ovarian_ivf_treatment_cost', country_name)
    queryset_list_sk_egg_ivf_val = procedure_country_average_value('egg_donor_recipients_cost', country_name)
    queryset_list_sk_known_egg_ivf_val = procedure_country_average_value('known_egg_donor_recipients_cost', country_name)
    queryset_list_sk_shared_egg_ivf_val = procedure_country_average_value('shared_egg_donor_recipients_cost', country_name)

    queryset_list_sk_embryo_ivf_val = procedure_country_average_value('embryo_donor_recipients_cost', country_name)
    queryset_list_sk_known_embryo_ivf_val = procedure_country_average_value('known_embryo_donor_recipients_cost', country_name)
    queryset_list_sk_sperm_ivf_val = procedure_country_average_value('sperm_donor_recipients_cost', country_name)
    queryset_list_sk_known_sperm_ivf_val = procedure_country_average_value('known_sperm_donor_recipients_cost', country_name)
    queryset_list_sk_icsi_val = procedure_country_average_value('icsi_treatment_cost', country_name)
    queryset_list_sk_iui_val = procedure_country_average_value('iui_treatment_cost', country_name)
    ...
    queryset_list_bratislava__ivf_val = procedure_region_average_value('ivf_treatment_cost', region_name)
    queryset_list_bratislava__egg_val = procedure_region_average_value('mild_ivf_treatment_cost', region_name)
    queryset_list_bratislava__embryo_val = procedure_region_average_value('ovarian_ivf_treatment_cost', region_name)
    queryset_list_bratislava__sperm_val = procedure_region_average_value('egg_donor_recipients_cost', region_name)
    queryset_list_bratislava__icsi_val = procedure_region_average_value('known_egg_donor_recipients_cost', region_name)
    queryset_list_bratislava__iui_val = procedure_region_average_value('shared_egg_donor_recipients_cost', region_name)
