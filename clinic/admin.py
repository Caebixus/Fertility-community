...
class PostAdmin(admin.ModelAdmin):
    ...
    save_as = True
    list_display = ('id', 'digitalTransparencyIndex', 'clinicName', 'clinicGoogleReviewsUrl', 'clinicOwner', 'clinicCity', 'update_list_date', 'is_published', 'is_claimed', 'pro_is_published', 'ppq_is_published', 'is_published_list_date', 'pro_update_is_published_list_date', 'clinicRegion', 'clinicState')
    ...
    fieldsets = (
        ...
        ('Best Articles Country', {'fields': ('best_article_country_boolean', 'best_article_country_actual_text', 'best_article_country_actual_prototype', 'best_article_country_blogpost_obj', )}),
        ('Best Articles State', {'fields': ('best_article_state_boolean', 'best_article_state_actual_text', 'best_article_state_actual_prototype', 'best_article_state_blogpost_obj', )}),
        ('Best Articles City', {'fields': ('best_article_city_boolean', 'best_article_city_actual_text', 'best_article_city_actual_prototype', 'best_article_city_blogpost_obj', )}),
