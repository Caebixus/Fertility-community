...
class PostAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ('Modular Best IVF clinic articles', {'fields': ('modular_country_active', 'modular_country', 'modular_country_actual_text', 'modular_country_actual_prototype', 'modular_country_fcreview_text',)}),
