...
CATEGORY_CHOICES_STATES_NORTH_AMERICA = {
    'United States': 'United States - ' + str(my_total_count_usa) + ' fertility clinics',
    'Mexico': 'Mexico - ' + str(my_total_count_mexico) + ' fertility clinics',
    }

CATEGORY_CHOICES_STATES_EUROPE = {
    'United Kingdom': 'United Kingdom - ' + str(my_total_count_uk) + ' fertility clinics',
    'Denmark': 'Denmark - ' + str(my_total_count_denmark) + ' fertility clinics',
    'Czech Republic': 'Czech Republic - ' + str(my_total_count_cze) + ' fertility clinics',
    'Slovakia': 'Slovakia - ' + str(my_total_count_slovakia) + ' fertility clinics',
    'Spain': 'Spain - ' + str(my_total_count_spain) + ' fertility clinics',
    'Greece': 'Greece - ' + str(my_total_count_greece) + ' fertility clinics',
    'Cyprus': 'Cyprus - ' + str(my_total_count_cyprus) + ' fertility clinics',
    'Germany': 'Germany - ' + str(my_total_count_germany) + ' fertility clinics',
    'Portugal': 'Portugal - ' + str(my_total_count_portugal) + ' fertility clinics',
    'Latvia': 'Latvia - ' + str(my_total_count_latvia) + ' fertility clinics',
    }

CATEGORY_CHOICES_STATES_ASIA = {
    'India': 'India - ' + str(my_total_count_india) + ' fertility clinics',
    }
...
CATEGORY_CHOICES_STATES_PACKAGES_NORTH_AMERICA = {
    'United States': 'United States - ' + str(my_total_package_count_usa) + ' packages',
