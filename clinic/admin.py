...
class PostAdmin(admin.ModelAdmin):
    save_as = True
    list_display = ('id', 'clinicName', 'clinicOwner', 'update_list_date', 'is_published', 'is_published_list_date', 'pro_update_is_published_list_date', 'type', 'clinicRegion', 'clinicState')
    ...
    fieldsets = (
        ...
        ('Packages', {'fields': ('package1title', 'package1desc', 'package1cost', 'package2title', 'package2desc', 'package2cost', 'package3title', 'package3desc', 'package3cost', 'package4title', 'package4desc', 'package4cost', 'package5title', 'package5desc', 'package5cost', 'package6title', 'package6desc', 'package6cost',)}),
