...
class PostAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ('Contact information', {'fields': ('clinic_url', 'contact_url', 'contact_phone', 'contact_email', 'query_email', 'fertilitycommunity_email',)}),
        ...
        ('Payment information', {'fields': ('payment_type_cash', 'payment_type_major_credit_cards', 'payment_type_debit_cards', 'payment_type_check', 'payment_type_cryptocurrency', 'payment_type_wire_transfer',)}),
        ...
        ('Modular Best IVF clinic articles - Country', {'fields': ('modular_country_active', 'modular_country', 'modular_country_actual_text', 'modular_country_actual_prototype', 'modular_country_fcreview_text', 'choices_of_best_list_country')}),
        ('Modular Best IVF clinic articles - State', {'fields': ('modular_state_active', 'modular_state', 'modular_state_actual_text', 'modular_state_actual_prototype','modular_state_fcreview_text', 'choices_of_best_list_state')}),
        ('Modular Best IVF clinic articles - City', {'fields': ('modular_city_active', 'modular_city', 'modular_city_actual_text', 'modular_city_actual_prototype', 'modular_city_fcreview_text', 'choices_of_best_list_city')}),
